  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-expanded={open}
        className={`group flex min-h-16 w-full items-center gap-3 rounded-2xl border bg-card px-3.5 py-3 text-start shadow-sm transition-all duration-200 ${
          open
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[11px] font-medium uppercase tracking-wide text-muted-foreground"><T text="Active farm" /></p>
            ...
            {farms.map((farm) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 rounded-xl px-2.5 py-2.5 text-start transition-all duration-150 ${
                    selected
                      ? "bg-primary/8"
                      : "hover:bg-muted/70"
                  }`}
