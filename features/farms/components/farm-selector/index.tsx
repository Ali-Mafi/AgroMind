  ...
  return (
    <div className="relative w-full sm:w-auto sm:min-w-60">
      ...
      <select
        ...
        className="w-full appearance-none rounded-2xl border bg-card py-3 pl-14 pr-10 text-left text-sm font-semibold shadow-sm outline-none transition-colors hover:bg-muted/50 focus:border-primary focus:ring-2 focus:ring-primary/20"
      >
        {farms.map((farm) => (
