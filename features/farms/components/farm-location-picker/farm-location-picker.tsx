  ...
  () => import("./farm-map"),
  {
    ...
    loading: () => (
      <div className="flex h-full items-center justify-center rounded-2xl bg-muted/40">
        <div className="text-sm text-muted-foreground"><T text="Loading map..." /></div>
      </div>
    ),
  },
);
  ...
  return (
    <>
      ...
      <button
        ...
        className="group flex w-full items-center gap-4 rounded-2xl border bg-background p-4 text-start transition-all hover:border-primary/50 hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20"
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            {selectedLocation
              ...
              : t("Choose the exact position of your farm on the map")}
          </p>
        </div>
        ...
        <span className="shrink-0 rounded-xl bg-primary/10 px-3 py-2 text-xs font-semibold text-primary transition-colors group-hover:bg-primary group-hover:text-primary-foreground">
          {selectedLocation ? t("Change") : t("Open Map")}
        </span>
      </button>
          ...
          >
            ...
            <div className="flex shrink-0 items-center justify-between gap-4 border-b px-5 py-4 sm:px-6">
              <div className="min-w-0">
                ...
                ><T text="Select Farm Location" /></h2>

                <p className="mt-1 text-xs text-muted-foreground sm:text-sm"><T text="Click on the map to place the exact location." /></p>
              </div>
            ...
            <div className="flex shrink-0 flex-col-reverse gap-3 border-t bg-card p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
              <p className="text-xs text-muted-foreground"><T text="More precise location = better weather data." /></p>
              ...
              <div className="flex flex-col-reverse gap-3 sm:flex-row">
                ...
                >
                  <Check className="h-4 w-4" /><T text="Save Location" /></button>
              </div>
            </div>
          </div>
        </div>
