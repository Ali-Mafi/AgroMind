...
function worker({ response, brokenStorage = false } = {}) {
  ...
  vm.runInNewContext(readFileSync("public/sw.js", "utf8"), {
    ...
    caches: {
      ...
      keys: async () => ["agromind-public-v3", "agromind-public-v4", "agromind-public-v5", "agromind-public-v6", "agromind-public-v7", "agromind-public-v8", "agromind-public-v9", "agromind-public-v10", "another-app"],
...
test("PWA install does not redownload the 1.1 MB logo and activation drops stale public caches", async () => {
  ...
  assert.deepEqual(sw.deleted, ["agromind-public-v3", "agromind-public-v4", "agromind-public-v5", "agromind-public-v6", "agromind-public-v7", "agromind-public-v8", "agromind-public-v9", "agromind-public-v10"]);
...
test("offline shell no longer depends on a separate Farmer Dino image asset", async () => {
  const sw = worker();
  await sw.lifecycle("install");
  assert.deepEqual(sw.installed, ["/offline.html"]);
  assert.equal(sw.installed.some(path => path.includes("farmer-dino")), false);
});
