...
function worker({ response, brokenStorage = false } = {}) {
  ...
  vm.runInNewContext(readFileSync("public/sw.js", "utf8"), {
    ...
    caches: {
      ...
      keys: async () => ["agromind-public-v3", "agromind-public-v4", "agromind-public-v5", "agromind-public-v6", "agromind-public-v7", "agromind-public-v8", "agromind-public-v9", "agromind-public-v10", "agromind-public-v11", "agromind-public-v12", "agromind-public-v13", "another-app"],
...
test("PWA install does not redownload the 1.1 MB logo and activation drops stale public caches", async () => {
  ...
  assert.deepEqual(sw.deleted, ["agromind-public-v3", "agromind-public-v4", "agromind-public-v5", "agromind-public-v6", "agromind-public-v7", "agromind-public-v8", "agromind-public-v9", "agromind-public-v10", "agromind-public-v11", "agromind-public-v12", "agromind-public-v13"]);
