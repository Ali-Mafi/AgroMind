...
function worker({ response, brokenStorage = false } = {}) {
  ...
  vm.runInNewContext(readFileSync("public/sw.js", "utf8"), {
    ...
    caches: {
      ...
      keys: async () => ["agromind-public-v3", "agromind-public-v4", "agromind-public-v5", "agromind-public-v6", "agromind-public-v7", "agromind-public-v8", "agromind-public-v9", "another-app"],
...
test("PWA install does not redownload the 1.1 MB logo and activation drops stale public caches", async () => {
  ...
  assert.deepEqual(sw.installed, ["/offline.html", "/offline/agro-runner/farmer-dino-sheet-v2.png"]);
  await sw.lifecycle("activate");
  assert.deepEqual(sw.deleted, ["agromind-public-v3", "agromind-public-v4", "agromind-public-v5", "agromind-public-v6", "agromind-public-v7", "agromind-public-v8", "agromind-public-v9"]);
...
test("precache serves Agro Runner sprite while fully offline", async () => {
  ...
  sw.entries.set(
    "https://agromind.test/offline/agro-runner/farmer-dino-sheet-v2.png",
    new Response("cached-sprite", { headers: { "Content-Type": "image/png" } }),
  );
  const response = await sw.request("/offline/agro-runner/farmer-dino-sheet-v2.png");
