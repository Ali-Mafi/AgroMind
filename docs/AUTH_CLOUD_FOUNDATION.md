...
The cloud browser rejected localhost preview access. Browser interaction, responsive screenshots and real email/session verification remain deployment acceptance checks; successful unit/SQL/build checks must not be described as those live checks.
